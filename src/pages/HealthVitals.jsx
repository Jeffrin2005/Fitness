...
function HealthVitals({ userData, onUserDataUpdate }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      {/* Premium Header */}
      <header className={`bg-white border-b border-blue-200 shadow-md sticky top-0 z-40 ${animateHeader ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
        <div className="w-full px-6 sm:px-8 lg:px-12 py-6">
          <div className="flex items-center justify-between">
            <div className={`${animateHeader ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>
            ...
            <div className={`flex items-center gap-6 ${animateHeader ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'}`}>
      ...
      <main className="w-full px-6 sm:px-8 lg:px-12 py-8">
        {/* Health Metrics */}
        <div className={`mb-8 ${animateStats ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <HealthMetrics />
        </div>

        {/* Premium Health Tips */}
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 ${animateContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="bg-white border border-pink-200 p-5">
            <div className="flex items-center justify-between mb-4">
        ...
        <div className={`bg-white border border-indigo-200 overflow-hidden ${animateContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200 rounded-xl">
              ...
              <div className="text-center p-4 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl">
